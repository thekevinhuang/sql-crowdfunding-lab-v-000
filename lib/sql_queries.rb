...
"SELECT projects.category, users.name, sum(pledges.amount) FROM projects JOIN pledges ON projects.id = pledges.project_id JOIN users ON users.id = pledges.user_id WHERE projects.category = \"books\";"
end
