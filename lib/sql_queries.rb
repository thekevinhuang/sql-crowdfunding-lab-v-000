...
"SELECT projects.category, sum(pleges.amount) FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.category HAVING projects.category = \"music\";"
end
